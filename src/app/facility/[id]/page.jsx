...
export default function FacilityDetailsPage() {
  ...
  const handleBooking = async (e) => {
    ...
    try {
      ...
      if (result.success || result.result?.insertedId) {
              ...
              <div>
                ...
                <div className="mt-5 flex flex-wrap gap-5 text-[#a7b0b8]">
                  ...
                  <p className="flex items-center gap-2">
                    ...
                    {facility.capacity} people capacity
                  </p>
                </div>
              </div>

              <div className="text-left sm:text-right">
                <p className="text-4xl font-black text-[#00d18f]">
                  ${facility.price_per_hour}
                </p>
                <p className="text-[#a7b0b8]">per hour</p>
              </div>
            </div>
